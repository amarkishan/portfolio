...
import './About.css';
import cv from '../images/Amar_Vaka_Java_Software_Engineer.docx'
      ...
      <div className="container">
        <div className="about-content">
          <div className="about-text">
            ...
            <p>I am a Full Stack Developer with 8+ years of experience in designing and developing scalable, high-performance applications. My expertise spans <b>Java</b>, Spring Boot microservices, and front-end technologies like <b>ReactJS</b>,<b>Angular</b> enabling me to build end-to-end solutions that are efficient, secure, and user-friendly. I have a strong background in cloud technologies (AWS, Azure), CI/CD pipelines, and DevOps tools like Docker and Kubernetes, ensuring seamless deployment and scalability.</p>
